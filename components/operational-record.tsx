...
const cards = [
  ...
  },
  {
    ...
    title: "Governance with Integirty",
    text: "Pushed for independent investigation and full accountability when student survey procedures weren't followed. Advocated for proper agenda notice and policy compliance on all committee actions. Withheld support on measures until replacement standards were clearly defined. Accountability isn't about disagreement, it's about making sure the process works for everyone.",
  },
  {
    overline: "SAFETY",
