...
const boxes = [
  {
    icon: Heart,
    label: "THE DAD",
    text: "Dad to Lillian & Madelyn students in BPS. When I vote on budgets, safety upgrades, or curriculum changes, my own kids are directly affected. That\u2019s my accountability. I go home every night.",
    href: "/dad",
  },
  {
    icon: Star,
